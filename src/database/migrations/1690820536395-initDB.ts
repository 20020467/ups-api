...
export class InitDB1690820536395 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`category\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`category_parent_id\` int UNSIGNED NULL, \`description\` text NULL, \`benefit\` text NULL, \`create_at\` datetime NULL, \`update_at\` datetime NULL, UNIQUE INDEX \`IDX_23c05c292c439d77b0de816b50\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE \`product\` (\`id\` bigint UNSIGNED NOT NULL AUTO_INCREMENT, \`category_id\` int UNSIGNED NOT NULL, \`brand\` varchar(255) NULL, \`price\` text NULL, \`name\` text NOT NULL, \`code\` varchar(255) NOT NULL, \`status\` tinyint NOT NULL DEFAULT '1', \`origin\` varchar(255) NULL COMMENT 'xuất xứ', \`wattage\` varchar(255) NULL COMMENT 'cong suat', \`guarantee\` int NULL COMMENT 'thoi han bao hanh (thang)', \`description\` text NULL, \`feature\` text NULL, \`create_at\` datetime NULL, \`update_at\` datetime NULL, UNIQUE INDEX \`IDX_99c39b067cfa73c783f0fc49a6\` (\`code\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
